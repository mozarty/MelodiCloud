 ...
 * @since 1.0
 *
 * This Class is used when @Constants.DEBUG_JSON is enabled to log the json being parsed
 */
public class GsonHttpDebugMessageConverter extends
	 ...
	 * {@link Gson#Gson() Gson}.
	 */
	public GsonHttpDebugMessageConverter() {
		this(new Gson());
	}
	 ...
	 */
	public GsonHttpDebugMessageConverter(boolean serializeNulls) {
	 ...
	 */
	public GsonHttpDebugMessageConverter(Gson gson) {
	...
	protected Object readInternal(Class<?> clazz, HttpInputMessage inputMessage)
		...
		LogUtil.logLongString("MessageConverter", jsonString);
		try {
			Type typeOfT = getType();
			if (typeOfT != null) {
				return this.gson.fromJson(jsonString, typeOfT);
			} else {
